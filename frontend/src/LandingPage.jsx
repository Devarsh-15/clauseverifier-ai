...
export default function LandingPage() {
  return (
    <div className="relative min-h-screen overflow-hidden bg-surface-0 text-gray-100">
      ...
      <main className="relative z-10 mx-auto w-full max-w-6xl px-4 pb-16 pt-12 sm:px-6 sm:pb-24 sm:pt-24">
        <section className="mx-auto max-w-4xl text-center">
          ...
          <h1 className="landing-title mt-8 text-balance text-3xl font-semibold leading-[1.1] tracking-tight text-white sm:text-6xl sm:leading-[1.08]">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-pretty text-base leading-relaxed text-gray-400 sm:text-lg">
            ClauseVerifier AI combines upload, structured analysis, and grounded chat — same dark theme
          ...
          <div className="mt-10 flex flex-col items-stretch justify-center gap-3 sm:flex-row sm:flex-wrap sm:items-center">
            <button
              type="button"
              onClick={() => navigate('/app')}
              className="group inline-flex items-center justify-center gap-2 rounded-xl bg-brand px-6 py-3.5 text-sm font-semibold text-white shadow-[0_0_40px_-8px_rgba(124,58,237,0.7)] transition-all duration-200 hover:bg-brand-light hover:shadow-[0_0_50px_-6px_rgba(124,58,237,0.85)]"
            >
              Get started
            ...
            <button
              type="button"
              onClick={() => navigate('/app')}
              className="inline-flex items-center justify-center gap-2 rounded-xl border border-surface-3 bg-surface-1/80 px-6 py-3.5 text-sm font-medium text-gray-200 backdrop-blur-sm transition-all duration-200 hover:border-brand/50 hover:bg-surface-2"
            >
        ...
        <section className="mt-16 rounded-2xl border border-surface-3/80 bg-gradient-to-br from-surface-1/90 to-surface-0/80 p-6 text-center backdrop-blur-sm sm:p-10">
          ...
          <button
            type="button"
            onClick={() => navigate('/app')}
            className="btn-primary mt-5 inline-flex w-full items-center justify-center gap-2 px-6 sm:w-auto"
          >
            Launch ClauseVerifier
            <ArrowRight size={15} />
          </button>
        </section>
      </main>
