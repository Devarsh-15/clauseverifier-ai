...
export default function FlowSection() {
  return (
    <section className="mx-auto mt-16 w-full max-w-6xl px-0 sm:mt-20" aria-labelledby="how-it-works-heading">
      <div className="rounded-2xl border border-surface-3/80 bg-surface-1/50 p-4 shadow-[0_0_0_1px_rgba(124,58,237,0.06)] backdrop-blur-md sm:p-8 lg:p-10">
        <h2
        ...
        <div className="mt-8 flex flex-col gap-4 sm:mt-10 lg:flex-row lg:items-stretch lg:justify-center lg:gap-2">
