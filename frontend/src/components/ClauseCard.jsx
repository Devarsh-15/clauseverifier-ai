  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="flex w-full items-start gap-3 p-3 text-left transition-colors hover:bg-surface-2/50 sm:p-4"
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <div className="flex flex-wrap items-center gap-2 mb-1">
            <span className="break-words text-sm font-semibold leading-snug text-gray-100">
              {clause.title}
            </span>
      ...
      {/* Expanded content */}
      {expanded && (
        <div className="space-y-4 border-t border-surface-3 px-3 pb-3 pt-4 sm:px-4 sm:pb-4">
          {/* Clause text excerpt */}
          {clause.text && (
            <div className="bg-surface-0 rounded-lg p-3">
              ...
              <p className="whitespace-pre-wrap break-words font-mono text-sm leading-relaxed text-gray-300">
                {clause.text}
              </p>
            </div>
          )}
