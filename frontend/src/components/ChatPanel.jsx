...
function MessageBubble({ msg }) {
  ...
  return (
    <div className={`flex gap-3 ${isUser ? 'flex-row-reverse' : ''}`}>
      ...
      <div className={`
        max-w-[86%] break-words px-4 py-3 rounded-2xl text-sm leading-relaxed sm:max-w-[78%]
        ${isUser
...
export default function ChatPanel({ documentId, documentType }) {
  ...
  return (
    <div className="grid h-[calc(100dvh-8rem)] min-h-[460px] grid-cols-1 overflow-hidden md:h-[680px] md:grid-cols-[minmax(0,240px)_minmax(0,1fr)] card">

      <aside className="flex min-h-[120px] max-h-[170px] flex-col border-b border-surface-3 bg-surface-1/50 md:max-h-none md:min-h-0 md:border-b-0 md:border-r">
      ...
      <div className="flex flex-col min-w-0 min-h-0">
        <div className="flex items-center gap-3 border-b border-surface-3 px-4 py-4 shrink-0 sm:px-5">
        ...
        <div className="flex-1 overflow-y-auto px-3 py-4 space-y-4 min-h-0 sm:px-5 sm:py-5">
          {messages.length === 0 ? (
        ...
        <div className="px-3 py-3 border-t border-surface-3 shrink-0 sm:px-4">
