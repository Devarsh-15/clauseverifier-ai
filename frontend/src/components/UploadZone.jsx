    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-8 sm:py-12">
      ...
      <div className="flex flex-col items-center gap-4 mb-8 sm:mb-12">
        ...
        <div className="text-center">
          <h1 className="text-2xl font-bold text-gray-100 tracking-tight sm:text-3xl">
            ClauseVerifier <span className="text-brand">AI</span>
          </h1>
      ...
      <div
        ...
        className={`
          w-full max-w-xl border-2 border-dashed rounded-2xl p-6 sm:p-12
      ...
      {/* Feature list */}
      <div className="mt-8 grid grid-cols-1 gap-4 max-w-xl w-full sm:mt-12 sm:grid-cols-3">
        {[
